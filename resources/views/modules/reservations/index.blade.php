...
@section('content')
    ...
    <div class="mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Gestão de Reservas</h1>
                <p class="text-gray-600 mt-1">Gerencie todas as reservas e agendamentos</p>
            </div>
            <div class="flex flex-wrap gap-2 mt-4 lg:mt-0">
                <a href="/reservas/export" class="inline-flex items-center px-3 py-1.5 border border-gray-300 rounded-md text-xs font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500">Reservas Hoje</p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">R$ {{ number_format($stats['monthly_revenue'], 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div id="advancedFilters" class="hidden mt-4 pt-4 border-t border-gray-200">
                <div class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="w-40">
                        ...
                        <select name="date_filter" class="block w-full px-2 py-1 border border-gray-300 rounded text-xs bg-white focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Moto</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-4 whitespace-nowrap">
                                <input type="checkbox" name="selected_reservations[]" value="{{ $reservation->id }}" class="rounded border-gray-300 text-gray-600 focus:ring-gray-500">
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div>
                                    <div class="text-sm font-medium text-gray-900">{{ $reservation->client->name }}</div>
                                    <div class="text-xs text-gray-500">ID: {{ $reservation->client->id }}</div>
                                </div>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div>
                                    <div class="text-sm font-medium text-gray-900">{{ $reservation->motorcycle->name }}</div>
                                    <div class="text-xs text-gray-500">{{ $reservation->motorcycle->license_plate }}</div>
                                </div>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div>
                                    <div class="text-sm font-medium text-gray-900">{{ $reservation->period_text }}</div>
                                    <div class="text-xs text-gray-500">{{ $reservation->date_range }}</div>
                                    <div class="text-xs text-gray-400">Criado em {{ $reservation->formatted_created_at }}</div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <a href="/reservas/{{ $reservation->id }}/edit" class="text-gray-600 hover:text-gray-900">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="/reservas/{{ $reservation->id }}" class="text-gray-600 hover:text-gray-900">
