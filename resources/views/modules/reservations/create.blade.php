    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Nova Reserva</h1>
                    <p class="text-gray-600 mt-1">Crie uma nova reserva no sistema</p>
                </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <p id="duration" class="text-sm font-medium text-gray-900">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500">Taxa Diária</p>
                                    <p id="daily_rate_display" class="text-sm font-medium text-gray-900">R$ 0,00</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500">Valor Total</p>
                                    <p id="total_amount" class="text-lg font-bold text-green-600">R$ 0,00</p>
                                </div>
                            </div>
                        </div>
                    </div>
