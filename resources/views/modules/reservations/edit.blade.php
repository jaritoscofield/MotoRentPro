    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Editar Reserva</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Atualize as informações da reserva</p>
                </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <p id="duration" class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $reservation->duration_days }} dia(s)</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Taxa Diária</p>
                                    <p id="daily_rate_display" class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $reservation->formatted_daily_rate }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Valor Total</p>
                                    <p id="total_amount" class="text-lg font-bold text-green-600 dark:text-green-400">{{ $reservation->formatted_total_amount }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
