    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Novo Cliente</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Cadastre um novo cliente no sistema</p>
                </div>
